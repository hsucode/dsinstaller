...
dim exepath
exepath=path&"\V6R2020x\AM_3DEXP_Platform.AllOS\2\3DSpace\Windows64\1\StartTUI.exe"
...
WScript.Sleep 6000
Shell.SendKeys "C:\DassaultSystemes\R2020x\3DSpace{ENTER}" 
...
WScript.Sleep 6000
Shell.SendKeys "C:\DassaultSystemes\3DSpaceData{ENTER}" 
...
WScript.Sleep 6000
Shell.SendKeys "http://v6r2020x.3de.com:19000{ENTER}" 
...
WScript.Sleep 6000
Shell.SendKeys "https://v6r2020x.3de.com:443/enoviav5{ENTER}" 
...
WScript.Sleep 6000
Shell.SendKeys "https://v6r2020x.3de.com:446/3dcomment{ENTER}" 
...
WScript.Sleep 6000
Shell.SendKeys "https://v6r2020x.3de.com:446/3dnotification{ENTER}" 
...
' Oracle Instance Name: //v6r2020x.3de.com:1521/orcl
...
' 3DSpace Full Text Search configuration URL: http://v6r2020x.3de.com:19000
...
' ENOVIA VPM V5 service URL: https://v6r2020x.3de.com:443/enoviav5
...
' ______________________________________
   ...
   ' 3DSpace registration in 3DPassport
' ______________________________________

' Please execute following script to complete the registration of 3DSpace into 3DPassport:
' <server>/<os>/code/command/3DSpaceRegistrationIn3DPassport.[sh|bat]
' Make sure 3DPassport is running before running this script.
...
' Chosen Apache TomEE+ connection port [CAS]: 9080
' Automatically fixed ports:
' - TomEE+ AJP port: 9007
' - TomEE+ shutdown port: 9006

' Automatically fixed ports for Apache TomEE+ [No CAS]:
' - TomEE+ connection port: 8070
' - TomEE+ AJP port: 9057
' - TomEE+ shutdown port: 9056
...
' The installation program has finished installing 3DEXPERIENCE R2020x on your computer, in C:\DassaultSystemes\R2020x\3DSpace.
