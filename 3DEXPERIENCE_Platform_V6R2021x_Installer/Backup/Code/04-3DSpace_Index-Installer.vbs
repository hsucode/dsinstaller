...
WScript.Sleep 6000
Shell.SendKeys "C:\DassaultSystemes\R2020x\3DSpaceIndex{ENTER}"
...
' Default [C:\DassaultSystemes\R2020x\3DSpaceIndex\win_b64\cv\data]:
...
' Files will be installed in the following directory:
  ' C:\DassaultSystemes\R2020x\3DSpaceIndex
' Installation mode: Custom
' Installation Type: Single Search Server
' Search Server: http://v6r2020x.3de.com:19000
' Search Server Number of Slices: 1
' Search Server Number of Analyzers: 2
' Search Server Data Path: C:\DassaultSystemes\R2020x\3DSpaceIndex\win_b64\cv\data
...
' The installation program has finished installing 3DEXPERIENCE R2020x on your computer, in C:\DassaultSystemes\R2020x\3DSpaceIndex.
