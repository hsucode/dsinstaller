...
set oShellLink = WshShell.CreateShortcut(strDesktop & "\3DEXPERIENCE R2019x CAA.lnk")

dim path
path =WshShell.CurrentDirectory

Const a = " -run ""3DEXPERIENCE"" -env 3DE_R2019x_AEC_CIV_EN_NATIVE_DP -direnv ""C:\Users\DESKTOP\Documents\XUS\APPS\00_DS_APP\01_DS_ENV"" -nowindow "
