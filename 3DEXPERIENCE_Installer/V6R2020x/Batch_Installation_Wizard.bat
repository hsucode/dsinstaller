...
%~dp0\Part_3DEXP_NativeApps.Windows64\1\Software\HF_NativeApps_3DEXP.HF9.Windows64\1\StartTUI.exe --silent  %~dp0\InstallData\UserIntentions_CODE_422.9.xml
...
%~dp0\Part_3DEXP_AppDevSuite.AllOS\1\Software\HF_CAABuildTime.HF9.Windows64\1\StartTUI.exe --silent  %~dp0\InstallData\UserIntentions_CAA_422.9.xml
