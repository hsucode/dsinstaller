...
net stop "3DSwym_R2019x"
timeout /t 3

net stop "3DEXPERIENCE R2019x 3DSwym ExternalConverterSvc"
timeout /t 3

net stop "3DComment_R2019x"
timeout /t 3

net stop "3DEXPERIENCE R2019x 3DNotification Node"
timeout /t 3
...
net start "3DSwym_R2019x"
timeout /t 3

net start "3DEXPERIENCE R2019x 3DSwym ExternalConverterSvc"
timeout /t 3

net start "3DComment_R2019x"
timeout /t 3

net start "3DEXPERIENCE R2019x 3DNotification Node"
timeout /t 3
