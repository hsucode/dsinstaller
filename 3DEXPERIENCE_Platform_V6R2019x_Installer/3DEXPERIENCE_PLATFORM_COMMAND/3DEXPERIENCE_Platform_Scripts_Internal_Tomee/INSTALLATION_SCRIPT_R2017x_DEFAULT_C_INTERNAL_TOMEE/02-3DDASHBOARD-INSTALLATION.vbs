...
Shell.Run "Z:\3DE-INSTALL\V6R2017X\AM_3DEXP_Platform.AllOS\2\3DDashboard\Windows64\1\StartTUI.exe"
' cmd start
...
'Choose the installation directory:Default [C:\DassaultSystemes\R2017x\3DDashboard]:
WScript.Sleep 1000
Shell.SendKeys "C:\DassaultSystemes\R2017x\3DDashboard{ENTER}" 
...
WScript.Sleep 1000
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:443/3dpassport{ENTER}"

'3DDashboard service URL,Default [https://3ddashboard.mydomain:443/3ddashboard]:
WScript.Sleep 1000
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:443/3ddashboard{ENTER}"

'3DCompass service URL,Default [https://3dspace.mydomain:443/3dspace]:
WScript.Sleep 1000
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:443/3dspace{ENTER}"
...
WScript.Sleep 1000
Shell.SendKeys "untrusted.3DEXPV6R2017x.3ds.com{ENTER}"
