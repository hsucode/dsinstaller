...
Shell.Run "Z:\3DE-INSTALL\V6R2017X\AM_3DEXP_Platform.AllOS\3\3DSpace\Windows64\1\StartTUI.exe"
' cmd start
...
'Choose the installation directory:Default [C:\DassaultSystemes\R2019x\3DSpace]:
WScript.Sleep 1000
Shell.SendKeys "C:\DassaultSystemes\R2017x\3DSpace" 
Shell.SendKeys "{ENTER}" 
...
WScript.Sleep 1000
Shell.SendKeys "//3DEXPV6R2017x.3ds.com:1521/orcl{ENTER}"
...
WScript.Sleep 1000
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:443/federated" 
Shell.SendKeys "{ENTER}" 
...
WScript.Sleep 1000
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:443/enoviav5" 
Shell.SendKeys "{ENTER}"
...
'Mail server name
WScript.Sleep 1000
Shell.SendKeys "3DEXPV6R2017x.3ds.com{ENTER}"
