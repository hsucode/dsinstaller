...
Shell.Run "Z:\3DE-INSTALL\V6R2018X\AM_3DEXP_Platform.AllOS\3\3DSpaceIndex\Windows64\1\StartTUI.exe"
' cmd start
...
'Choose the installation directory:Default [C:\DassaultSystemes\R2018x\3DSpaceIndex]:
WScript.Sleep 1000
Shell.SendKeys "C:\DassaultSystemes\R2018x\3DSpaceIndex{ENTER}" 
...
'Search Server Data Path:Default [C:\DassaultSystemes\R2018x\3DSpaceIndex\win_b64\cv\data]:
WScript.Sleep 1000
Shell.SendKeys "{ENTER}" 
