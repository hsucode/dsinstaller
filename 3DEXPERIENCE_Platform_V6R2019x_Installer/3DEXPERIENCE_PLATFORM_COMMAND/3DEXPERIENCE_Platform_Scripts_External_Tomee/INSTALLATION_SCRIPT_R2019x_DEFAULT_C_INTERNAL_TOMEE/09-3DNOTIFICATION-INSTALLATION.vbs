...
' Default [C:\DassaultSystemes\R2019x\3DNotification]:
WScript.Sleep 3000
Shell.SendKeys "{ENTER}" 
...
' Default [C:\DassaultSystemes\R2019x\3DNotification\3DNotificationLogs]:
WScript.Sleep 3000
Shell.SendKeys "{ENTER}" 
...
'Mail server name
WScript.Sleep 3000
Shell.SendKeys "3dexpv6r2019x.3ds.com{ENTER}"
...
' Files will be installed in the following directory:
  ' C:\DassaultSystemes\R2019x\3DNotification
' Server JRE or JDK path: C:\Java\Jdk(x64)
' Directory for shared storage: C:\DassaultSystemes\3DNotificationData
' Directory for log files: C:\DassaultSystemes\R2019x\3DNotification\3DNotificationLogs
