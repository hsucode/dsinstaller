...
Shell.Run "Z:\3DE-INSTALL\V6R2019X\AM_3DEXP_Platform.AllOS\1\3DDashboard\Windows64\1\StartTUI.exe"
' cmd start
...
WScript.Sleep 2000
Shell.SendKeys "https://3dexpv6r2019x.3ds.com:443/3dpassport{ENTER}"

'3DDashboard service URL,Default [https://3ddashboard.mydomain:443/3ddashboard]:
WScript.Sleep 2000
Shell.SendKeys "https://3dexpv6r2019x.3ds.com:443/3ddashboard{ENTER}"

'3DCompass service URL,Default [https://3dspace.mydomain:443/3dspace]:
WScript.Sleep 2000
Shell.SendKeys "https://3dexpv6r2019x.3ds.com:443/3dspace{ENTER}"
...
WScript.Sleep 2000
Shell.SendKeys "untrusted.3dexpv6r2019x.3ds.com{ENTER}"
