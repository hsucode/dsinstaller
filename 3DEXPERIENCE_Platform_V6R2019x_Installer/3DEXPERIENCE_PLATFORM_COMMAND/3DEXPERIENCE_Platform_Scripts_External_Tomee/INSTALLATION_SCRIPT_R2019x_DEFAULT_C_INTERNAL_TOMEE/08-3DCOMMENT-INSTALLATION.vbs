...
Shell.Run "Z:\3DE-INSTALL\V6R2019X\AM_3DEXP_Platform.AllOS\2\3DComment\Windows64\1\StartTUI.exe"
' cmd start
...
' Default [C:\DassaultSystemes\R2019x\3DComment]:
WScript.Sleep 3000
Shell.SendKeys "{ENTER}" 
...
' Default [C:\DassaultSystemes\R2019x\3DComment\3DCommentLog]:
WScript.Sleep 3000
Shell.SendKeys "{ENTER}" 
...
WScript.Sleep 3000
Shell.SendKeys "https://3dexpv6r2019x.3ds.com:443/3ddashboard" 
Shell.SendKeys "{ENTER}" 
...
WScript.Sleep 3000
Shell.SendKeys "https://3dexpv6r2019x.3ds.com:446/3dcomment" 
Shell.SendKeys "{ENTER}" 
...
WScript.Sleep 3000
Shell.SendKeys "https://3dexpv6r2019x.3ds.com:446/3dnotification" 
Shell.SendKeys "{ENTER}" 
...
WScript.Sleep 3000
Shell.SendKeys "//3dexpv6r2019x.3ds.com:1521/orcl{ENTER}"
...
' Files will be installed in the following directory:
  ' C:\DassaultSystemes\R2019x\3DComment
' Server JRE or JDK path: C:\Java\Jdk(x64)
' Directory for shared storage: C:\DassaultSystemes\3DCommentData
' Directory for log files: C:\DassaultSystemes\R2019x\3DComment\3DCommentLog
' Directory for runtime temporary files: C:\Users\ADMINI~1\AppData\Local\Temp\Dassault Systemes\3DComment
' 3DPassport service URL: https://3dexpv6r2019x.3ds.com:443/3dpassport
' 3DDashboard service URL: https://3dexpv6r2019x.3ds.com:443/3ddashboard
' 3DCompass service URL: https://3dexpv6r2019x.3ds.com:443/3dspace
' 3DComment service URL: https://3dexpv6r2019x.3ds.com:446/3dcomment
' 3DNotification service URL: https://3dexpv6r2019x.3ds.com:446/3dnotification
...
' Database Service Name for 3DComment: //3dexpv6r2019x.3ds.com:1521/orcl
