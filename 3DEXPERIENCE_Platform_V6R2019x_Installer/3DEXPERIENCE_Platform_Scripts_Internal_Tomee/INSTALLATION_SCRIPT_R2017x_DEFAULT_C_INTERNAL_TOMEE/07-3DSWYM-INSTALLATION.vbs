...
'install 3d swym
Shell.Run "Z:\G\3DSwym\Windows64\1\StartTUI.exe"
'Welcome to the 3DEXPERIENCE R2017x Beta 1835 installation program.Enter selection (default: Next):
WScript.Sleep 3000
Shell.SendKeys "{ENTER}" 

'Choose the installation directory:Default [C:\DassaultSystemes\R2017x\3DSwym]:
Shell.SendKeys "C:\DassaultSystemes\R2017x\3DSwym{ENTER}" 
...
'Choose directory for log files:Default [C:\DassaultSystemes\R2017x\3DSwym\3DSwymLog]:
Shell.SendKeys "{ENTER}"
...
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:443/3dpassport"
Shell.SendKeys "{ENTER}"

'3DSwym Full Text Search configuration URL
Shell.SendKeys "http://3DEXPV6R2017x.3ds.com:29000"
Shell.SendKeys "{ENTER}"

'3DDashboard service URL
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:443/3ddashboard"
Shell.SendKeys "{ENTER}"

'3DCompass service URL
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:443/3dspace"
Shell.SendKeys "{ENTER}"
...
'3DSwym service URL
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:444/3dswym"
Shell.SendKeys "{ENTER}"

'3DComment service URL
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:446/3dcomment"
Shell.SendKeys "{ENTER}"

'3DNotification service URL
Shell.SendKeys "https://3DEXPV6R2017x.3ds.com:446/3dnotification"
Shell.SendKeys "{ENTER}"
...
Shell.SendKeys "//3DEXPV6R2017x.3ds.com:1521/orcl"
Shell.SendKeys "{ENTER}"
...
'Mail server name
Shell.SendKeys "3DEXPV6R2017x.3ds.com"
Shell.SendKeys "{ENTER}"
...
'CloudView data directory,Default [C:\DassaultSystemes\R2017x\3DSwym\win_b64\datadir]:
Shell.SendKeys "{ENTER}"
